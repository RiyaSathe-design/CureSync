    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          ...
          <p>Our commitment to excellence drives us to constantly innovate and integrate the latest healthcare technologies, ensuring an intuitive and efficient experience for our users. Whether it’s your first consultation or ongoing health management, CureSync is here to make every step effortless and convenient.</p>
